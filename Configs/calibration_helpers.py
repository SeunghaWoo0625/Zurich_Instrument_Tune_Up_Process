...
def calibrate_devices(
    ...
    #             lsg.logical_signals["measure"].calibration = SignalCalibration(
    ...
    #             )
    #             lsg.logical_signals["acquire"].calibration = SignalCalibration(
    #                 local_oscillator=measure_lo_osc,
    ...
    #     lsg.logical_signals["drive"].calibration = SignalCalibration(
    #         oscillator=ge_osc,
    ...
    #     lsg.logical_signals["drive_ef"].calibration = SignalCalibration(
    #         oscillator=ef_osc,
    #         local_oscillator=drive_lo_osc
    #     )
