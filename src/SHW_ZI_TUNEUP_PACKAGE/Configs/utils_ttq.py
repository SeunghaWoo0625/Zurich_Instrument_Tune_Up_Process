...
QUBIT_PARAMETERS_FILE =  ConfigsPath / "qubit_parameters_ttq.json"
...
def update_params(qubit_params, param_f_path : str | None = None):
    param_f_path = QUBIT_PARAMETERS_FILE if param_f_path is None else param_f_path
    with open(param_f_path, 'w') as f:
